 ...
 */
public class TJMarqueeTextView extends View {
    ...
    public TJMarqueeTextView(Context context) {
        super(context);
        init(null);
    }

    public TJMarqueeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public TJMarqueeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void readAttrs(AttributeSet attrs) {
        ...
        int[] attrsArray = new int[]{
                ...
                android.R.attr.text,
                R.styleable.TJMarqueeTextView_marqueeEnabled,
                R.styleable.TJMarqueeTextView_edgeEffectEnabled,
                R.styleable.TJMarqueeTextView_edgeEffectWidth,
                R.styleable.TJMarqueeTextView_edgeEffectColor,
                R.styleable.TJMarqueeTextView_pauseDuration,
                R.styleable.TJMarqueeTextView_forceMarquee,
                R.styleable.TJMarqueeTextView_centerText,
        };

        TypedArray ta = getContext().obtainStyledAttributes(attrs, attrsArray);

        textSize = ta.getDimension(attrsArray[0], textSize); // 2 is the index in the array of the textSize attribute
        textColor = ta.getColor(attrsArray[1], textColor); // 3 is the index of the array of the textColor attribute
        text = ta.getText(attrsArray[2]);
        marqueeEnabled = ta.getBoolean(attrsArray[3], marqueeEnabled);
        edgeEffectEnabled = ta.getBoolean(attrsArray[4], edgeEffectEnabled);
        edgeEffectWidth = ta.getInt(attrsArray[5], edgeEffectWidth);
        edgeEffectColor = ta.getColor(attrsArray[6], edgeEffectColor);
        pauseDuration = ta.getInt(attrsArray[7], pauseDuration);
        forceMarquee = ta.getBoolean(attrsArray[8], forceMarquee);
        centerText = ta.getBoolean(attrsArray[9], centerText);
