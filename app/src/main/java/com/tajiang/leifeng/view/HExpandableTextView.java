...
/**
 * Created by Admins on 2016/11/3.
 */

public class HExpandableTextView extends LinearLayout implements View.OnClickListener {

    private static final String TAG = HExpandableTextView.class.getSimpleName();
    ...
    public HExpandableTextView(Context context) {
        this(context, null);
    }

    public HExpandableTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public HExpandableTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onClick(View view) {
        if (mButton.getVisibility() != View.VISIBLE && view.getId() != mButton.getId()) {
            return;
        }
        changeCollapsedState();
    }

    private void changeCollapsedState() {
...
//        LogUtils.e("position :" + position + ", collapsedStatus.get(position, true) " + isCollapsed);
