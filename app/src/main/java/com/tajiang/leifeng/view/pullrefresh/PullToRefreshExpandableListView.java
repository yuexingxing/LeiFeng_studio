 ...
 * @since 2013-8-15
 */
public class PullToRefreshExpandableListView extends PullToRefreshBase<ActionSlideExpandableListView> implements OnScrollListener {
    ...
    @Override
    protected ActionSlideExpandableListView createRefreshableView(Context context, AttributeSet attrs) {
    	ActionSlideExpandableListView listView = new ActionSlideExpandableListView(context);
        mListView = listView;
