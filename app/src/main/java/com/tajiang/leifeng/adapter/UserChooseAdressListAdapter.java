...
import com.tajiang.leifeng.activity.UserChooseAddressActivity;
...
public class UserChooseAdressListAdapter extends CommonAdapter<UserAddress> implements View.OnClickListener {

    private UserChooseAddressActivity userAdressActivity;

    private OnSetDefaultAdressOnClickListener mOnSetDefaultAdressOnClickListener;

    public UserChooseAdressListAdapter(Context context, List<UserAddress> mDatas, int itemLayoutId) {
        super(context, mDatas, itemLayoutId);
        userAdressActivity = (UserChooseAddressActivity) context;
    }

    @Override
    public void convert(final ViewHolder helper, UserAddress item) {
...
//        helper.setText(R.id.tv_phoneUserAdress, item.getMobPhone());
        ...
        // 点击设置默认地址
        helper.getView(R.id.rectSetAdressDefault).setOnClickListener(new View.OnClickListener() {
            @Override
