...
public class UserAdressActivity extends BaseActivity implements HttpResponseListener, OnMenuItemClickListener, UserAdressListAdapter.OnSetDefaultAdressOnClickListener {

    private View rect_addressEmpty;

    private SwipeMenuListView lv_adressUser;

    private UserAdressListAdapter userAdressListAdapter;
    ...
    protected void initView() {
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                deleteItem.setWidth(DensityUtils.dp2px(UserAdressActivity.this, 90));
    ...
    protected void initAdapter() {
        userAdressListAdapter = new UserAdressListAdapter(this, userAddressList, R.layout.item_list_user_adress);
...
//    }
    ...
    public void onSetDefaultAdressOnClick(int postion) {
        ...
        TJHttpUtil.getInstance(this).setAddressDefault(userAddress.getAddressId());
    }
    ...
    public void onSuccess(com.tajiang.leifeng.common.http.BaseResponse response, int requestTag) {
        switch (requestTag) {
            ...
            case TJRequestTag.TAG_USER_ADDRESS_DEFAULT:
                UserUtils.getInstance().doUserRefreshNetUserInfor();
                TJHttpUtil.getInstance(this).getAdressList(1, 100);
                break;
        }
